...
export default React.createClass({
    ...
    <
        TableRowColumn > {player.position
    }<
        /TableRowColumn>
        < TableRowColumn > {player.name
    }<
        /TableRowColumn>
        < TableRowColumn > {player.salary
    }<
        /TableRowColumn>
        < TableRowColumn > {player.projection
    }<
        /TableRowColumn>
        < TableRowColumn >
        < span
        onClick = {this.lock.bind(this, player)
    }>
        {
            player.locked ?
        <
    ...
    <
        ...
        < TableRowColumn >
        < span
        onClick = {this.ban.bind(this, player)
    }>
        {
            player.banned ?
        <
